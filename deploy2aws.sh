...
# TODO Currently generated  /target/Docker/Dockerfile needs to be patched when deployed on aws: Replace this line
# ADD opt /opt  -> ADD stage /
sed -i '' '4s/.*/ADD stage \//' ./target/Docker/Dockerfile
